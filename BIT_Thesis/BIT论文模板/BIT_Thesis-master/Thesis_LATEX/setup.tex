...
\newtheorem{definition}{\hspace{\parindent}定义}
...
%\titleformat{\chapter}[hang]{\vspace{-2.5cm}\chapterfmt}{\chaptername}{1em}{}
\titleformat{\chapter}[hang]{\vspace{-2.4cm}\chapterfmt}{\chaptername}{0.5em}{}[\vspace{-0.6cm}]
...
\titleformat{\subsubsection}[hang]{\subsubsectionfmt}{\subsubsectionname}{0.5em}{}

%%用titletoc宏包定义目录格式
\usepackage{titletoc}
%%设置目录里章节标题格式
\def\tocchapterfmt{\songti\xiaosizi\vspace{0.1cm}}
\def\tocsectionfmt{\songti\xiaosizi\vspace{0.1cm}}
\def\tocsubsectionfmt{\songti\xiaosizi}
\def\tocsubsubsectionfmt{\songti\xiaosizi}


\def\mydotfill{\hspace{.5em}\titlerule*[7pt]{\textbf{.}}}
%\titlecontents{chapter}[0pt]{\tocchapterfmt} {\thecontentslabel\quad}{} {\mydotfill\contentspage}
\titlecontents{chapter}[0em]{\tocchapterfmt} {\thecontentslabel\hspace{0.3em}}{} {\mydotfill\hspace{-0.5em}\contentspage}
\titlecontents{section}[2em]{\tocsectionfmt} {\thecontentslabel\hspace{0.3em}}{} {\mydotfill\hspace{-0.5em}\contentspage}
\titlecontents{subsection}[4em]{\tocsubsectionfmt} {\thecontentslabel\hspace{0.3em}}{} {\mydotfill\hspace{-0.5em}\contentspage}
\titlecontents{subsubsection}[4em]{\tocsubsubsectionfmt} {\thecontentslabel\hspace{0.3em}}{} {\mydotfill\hspace{-0.5em}\contentspage}
...
%%用tocbibind宏包自动将参考文献、索引、表格目录和图形目录等标题及其所在页码加入目录
